...
const SYMBOL_VERSION = "multiplier-cats-20260616-112937";
...
function initBoardTunePanel() {
  ...
  const controls = [
    { heading: "20段光環" },
    { label: "光環 X", name: "--slot-ring-x", min: -50, max: 150, step: 0.1, value: 50, unit: "%" },
    { label: "光環 Y", name: "--slot-ring-y", min: -50, max: 150, step: 0.1, value: 51.1, unit: "%" },
